    ...
    <div className="min-h-screen bg-neutral-950">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <div className="inline-block bg-white text-gray-900 px-4 py-2 rounded-lg font-bold text-sm sm:text-base">
        ...
        <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto mb-12 sm:mb-16">
          ...
          <Card className="border-2 border-gray-700 bg-gray-800">
            <CardHeader className="pb-4">
              <CardTitle className="text-xl sm:text-2xl font-bold text-white mb-2">Starter</CardTitle>
            ...
            <CardContent className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-white font-bold text-sm sm:text-base">$79/mo</span>
              ...
              <Link href="/login" className="block">
                <Button className="w-full h-12 sm:h-14 text-base sm:text-lg font-bold bg-white text-gray-900 hover:bg-gray-100">
                  Start Free Trial
                </Button>
              </Link>
            </CardContent>
          ...
          <Card className="border-4 border-white/60 bg-gray-800 relative">
            ...
            <CardHeader className="pt-10 sm:pt-12 pb-4">
              <CardTitle className="text-xl sm:text-2xl font-bold text-white mb-2">Pro</CardTitle>
            ...
            <CardContent className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-white font-bold text-sm sm:text-base">$149/mo</span>
                  <span className="text-gray-400 text-sm">billed annually</span>
              ...
              {/* Features */}
              <div className="space-y-2 sm:space-y-3 pt-4 border-t border-gray-700">
                <div className="text-white font-bold text-base sm:text-lg">✓ Unlimited quotes</div>
                <div className="text-white font-bold text-base sm:text-lg">✓ Unlimited users</div>
                <div className="text-white font-bold text-base sm:text-lg">✓ Priority support</div>
                <div className="text-gray-300 text-sm sm:text-base">✓ Quote generation</div>
                <div className="text-gray-300 text-sm sm:text-base">✓ SMS sending</div>
                <div className="text-gray-300 text-sm sm:text-base">✓ E-signature integration</div>
        ...
        <div className="bg-black rounded-2xl p-6 sm:p-8 max-w-4xl mx-auto border border-white/10">
          <div className="grid sm:grid-cols-3 gap-6 text-center">
            <div className="space-y-2">
              <h3 className="text-white font-bold text-base sm:text-lg">14-day free trial</h3>
              <p className="text-gray-400 text-xs sm:text-sm">(no card required)</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-white font-bold text-base sm:text-lg">Cancel anytime</h3>
              <p className="text-gray-400 text-xs sm:text-sm">or downgrade anytime</p>
            </div>
            <div className="space-y-2">
              <h3 className="text-white font-bold text-base sm:text-lg">Money-back guarantee</h3>
        ...
        <div className="text-center mt-12 sm:mt-16">
          ...
          <Link href="/login">
            <Button className="h-14 sm:h-16 px-8 sm:px-12 text-base sm:text-lg font-bold bg-white text-gray-900 hover:bg-gray-100">
