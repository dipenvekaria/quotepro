...
-- COMPANIES_NEW
-- ============================================
CREATE INDEX idx_companies_new_name ON companies_new(name);

-- ============================================
-- USERS_NEW
-- ============================================
CREATE INDEX idx_users_new_company_id ON users_new(company_id);
CREATE INDEX idx_users_new_role ON users_new(role);
CREATE INDEX idx_users_new_is_active ON users_new(is_active);

-- ============================================
-- CUSTOMERS_NEW
-- ============================================
CREATE INDEX idx_customers_new_company_id ON customers_new(company_id);
CREATE INDEX idx_customers_new_email ON customers_new(email);
CREATE INDEX idx_customers_new_phone ON customers_new(phone);
CREATE INDEX idx_customers_new_name ON customers_new(name);
CREATE INDEX idx_customers_new_created_at ON customers_new(created_at DESC);

-- For full-text search on customer names
CREATE INDEX idx_customers_new_name_trgm ON customers_new USING gin(name gin_trgm_ops);
...
CREATE INDEX idx_customer_addresses_zip ON customer_addresses(zip);

-- ============================================
-- LEADS_NEW
-- ============================================
CREATE INDEX idx_leads_new_company_id ON leads_new(company_id);
CREATE INDEX idx_leads_new_customer_id ON leads_new(customer_id);
CREATE INDEX idx_leads_new_status ON leads_new(status);
CREATE INDEX idx_leads_new_assigned_to ON leads_new(assigned_to);
CREATE INDEX idx_leads_new_created_at ON leads_new(created_at DESC);
CREATE INDEX idx_leads_new_scheduled_visit_at ON leads_new(scheduled_visit_at);

-- Composite indexes for common queries
CREATE INDEX idx_leads_new_company_status ON leads_new(company_id, status);
CREATE INDEX idx_leads_new_company_assigned ON leads_new(company_id, assigned_to, status);

-- ============================================
-- QUOTES_NEW
-- ============================================
CREATE INDEX idx_quotes_new_company_id ON quotes_new(company_id);
CREATE INDEX idx_quotes_new_customer_id ON quotes_new(customer_id);
CREATE INDEX idx_quotes_new_lead_id ON quotes_new(lead_id);
CREATE INDEX idx_quotes_new_status ON quotes_new(status);
CREATE INDEX idx_quotes_new_created_by ON quotes_new(created_by);
CREATE INDEX idx_quotes_new_created_at ON quotes_new(created_at DESC);
CREATE INDEX idx_quotes_new_sent_at ON quotes_new(sent_at DESC);
CREATE INDEX idx_quotes_new_quote_number ON quotes_new(quote_number);

-- Composite indexes for common queries
CREATE INDEX idx_quotes_new_company_status ON quotes_new(company_id, status);
CREATE INDEX idx_quotes_new_company_created ON quotes_new(company_id, created_at DESC);

-- ============================================
-- QUOTE_ITEMS_NEW
-- ============================================
CREATE INDEX idx_quote_items_new_quote_id ON quote_items_new(quote_id);
CREATE INDEX idx_quote_items_new_sort_order ON quote_items_new(quote_id, sort_order);

-- ============================================
-- QUOTE_OPTIONS
-- ============================================
CREATE INDEX idx_quote_options_quote_id ON quote_options(quote_id);
CREATE INDEX idx_quote_options_tier ON quote_options(tier);
CREATE INDEX idx_quote_options_is_selected ON quote_options(is_selected);

-- ============================================
-- JOBS_NEW
-- ============================================
CREATE INDEX idx_jobs_new_company_id ON jobs_new(company_id);
CREATE INDEX idx_jobs_new_quote_id ON jobs_new(quote_id);
CREATE INDEX idx_jobs_new_customer_id ON jobs_new(customer_id);
CREATE INDEX idx_jobs_new_status ON jobs_new(status);
CREATE INDEX idx_jobs_new_scheduled_start ON jobs_new(scheduled_start);
CREATE INDEX idx_jobs_new_scheduled_end ON jobs_new(scheduled_end);
CREATE INDEX idx_jobs_new_job_number ON jobs_new(job_number);

-- Composite indexes for calendar/schedule views
CREATE INDEX idx_jobs_new_company_schedule ON jobs_new(company_id, scheduled_start, scheduled_end);
CREATE INDEX idx_jobs_new_company_status ON jobs_new(company_id, status);

-- GIN index for array searches (assigned_to)
CREATE INDEX idx_jobs_new_assigned_to ON jobs_new USING gin(assigned_to);

-- ============================================
-- INVOICES_NEW
-- ============================================
CREATE INDEX idx_invoices_new_company_id ON invoices_new(company_id);
CREATE INDEX idx_invoices_new_job_id ON invoices_new(job_id);
CREATE INDEX idx_invoices_new_customer_id ON invoices_new(customer_id);
CREATE INDEX idx_invoices_new_status ON invoices_new(status);
CREATE INDEX idx_invoices_new_due_date ON invoices_new(due_date);
CREATE INDEX idx_invoices_new_created_at ON invoices_new(created_at DESC);
CREATE INDEX idx_invoices_new_invoice_number ON invoices_new(invoice_number);

-- Composite indexes for common queries
CREATE INDEX idx_invoices_new_company_status ON invoices_new(company_id, status);
CREATE INDEX idx_invoices_new_company_due ON invoices_new(company_id, due_date);
...
CREATE INDEX idx_catalog_items_subcategory ON catalog_items(subcategory);
...
CREATE INDEX idx_catalog_items_company_active ON catalog_items(company_id, is_active);

-- Full-text search on catalog items
CREATE INDEX idx_catalog_items_name_trgm ON catalog_items USING gin(name gin_trgm_ops);
CREATE INDEX idx_catalog_items_description_trgm ON catalog_items USING gin(description gin_trgm_ops);
...
CREATE INDEX idx_ai_conversations_entity_id ON ai_conversations(entity_id);
CREATE INDEX idx_ai_conversations_created_at ON ai_conversations(created_at DESC);

-- Composite index for analytics
CREATE INDEX idx_ai_conversations_company_created ON ai_conversations(company_id, created_at DESC);
...
CREATE INDEX idx_document_embeddings_company_type ON document_embeddings(company_id, document_type);
...
CREATE INDEX idx_ai_prompts_is_default ON ai_prompts(is_default);
